...
}; // enjoyvideo.instrinsicRatioVideos
...
enjoyvideoDomReady( function() {
    enjoyvideo.toggles.init();              // Handle toggles.
    enjoyvideo.coverModals.init();          // Handle cover modals.
    enjoyvideo.intrinsicRatioVideos.init(); // Retain aspect ratio of videos on window resize.
    enjoyvideo.modalMenu.init();            // Modal Menu.
    enjoyvideo.primaryMenu.init();          // Primary Menu.
    enjoyvideo.touchEnabled.init();         // Add class to body if device is touch-enabled.
} );
